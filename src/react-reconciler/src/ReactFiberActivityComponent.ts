import type {
  // ReactNodeList,
  OffscreenMode, Wakeable} from 'shared/ReactTypes';
...
export type OffscreenState = {
  ...
  baseLanes: Lanes,
  cachePool: any // SpawnedCachePool | null,
};
...
export type OffscreenQueue = {
  ...
  markerInstances: Array<any> | null,
...
export type OffscreenInstance = {
  ...
  _pendingMarkers: Set<any> | null,
  // _transitions: Set<Transition> | null,
  _transitions: Set<any> | null,
